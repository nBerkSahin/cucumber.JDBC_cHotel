...
public class DBStepDefinitions {
    ...
    @Given("kullanıcı cHotel DB sine baglanır")
    public void kullanıcıCHotelDBSineBaglanır() throws SQLException {
    ...
    public void kullanıcıTablosundakiVerileriniAlır(String table, String field) throws SQLException {
    ...
    @Given("kullanıcı {string} sutunundaki verileri okur ve istediği işlemleri yapar")
    public void kullanıcıSutunundakiVerileriOkurVeIstediğiIşlemleriYapar(String field) throws SQLException {
